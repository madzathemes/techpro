      ...
      <div class="author-info">
        <div class="author-avatar">
          ...
          <div class="author-description">
            <h5><?php echo esc_html__( 'Author', 'techpro' ); ?></h5>
            <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author"><h3><?php printf( esc_html__( '%s', 'techpro' ), get_the_author() ); ?></h3></a>
          ...
          <div class="author-link">
            <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
              <?php printf( esc_html__( 'View all posts by %s', 'techpro' ), get_the_author() ); ?>
            </a>
          </div>
        </div>
      </div>
